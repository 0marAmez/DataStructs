...
void freeList (List* pL); //Frees all heap memory associated with *pL to NULL
...
bool equals (List A, List B); //Returns true iff List A and B are in the same state,else false
bool isEmpty(List L);
